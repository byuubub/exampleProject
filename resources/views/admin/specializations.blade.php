...
<div class="space-y-6 fade-in" x-data="specManagement()">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button @click="openModal()" class="inline-flex items-center px-4 py-2.5 rounded-xl bg-teal-500 text-white font-medium hover:bg-teal-600">
    ...
    <div x-show="showModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-sm bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6" @click.stop>
            <div class="flex items-center justify-between mb-5">
                <h3 class="font-semibold text-gray-900 dark:text-white" x-text="editMode ? 'Edit Specialization' : 'Add Specialization'"></h3>
                <button @click="showModal = false" class="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-400">
                    <i class="fa-solid fa-xmark"></i>
                </button>
            </div>
            <form :action="editMode ? `/admin/specializations/${form.id}` : '{{ route('admin.specializations.store') }}'"
                ...
                <div class="flex space-x-3 pt-2">
                    ...
                    <button type="submit" class="flex-1 py-2.5 rounded-xl bg-teal-500 text-white font-medium hover:bg-teal-600">
...
function specManagement() {
    return {
        showModal: false, showDeleteModal: false, editMode: false,
        deleteTarget: { id: null, name: '' },
        form: { id: null, name: '', description: '' },
        openModal() { this.editMode = false; this.form = { id: null, name: '', description: '' }; this.showModal = true; },
        editSpec(s) { this.editMode = true; this.form = { ...s }; this.showModal = true; },
